...
# Undocumented alternate manual procedure coils.
MANUAL_PROCEDURE_COIL_ALT = 70
POWER_CONTACTOR_COIL_ALT = 71
FILL_VALVE_COIL_ALT = 72
DRAIN_PUMP_COIL_ALT = 73
ALARM_COIL_ALT = 74
DEHUMIDIFIER_COIL_ALT = 75
