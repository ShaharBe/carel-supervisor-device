...
REGISTER_DEFS: Sequence[RegisterDef] = (
    ...
    RegisterDef("I", 136, True, "humidifier status: 0 = on duty; 1 = alarm(s) present; 2 = disabled via network; 3 = disabled by timer; 4 = disabled by remote on/off; 5 = disabled by keyboard; 6 = manual control; 7 = no demand"),
